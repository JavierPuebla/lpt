	...
	switch(o.method){
		...
		case 'listado':
				...
				if(o.sending){
					...
					const tblData = {struct:o.struct,data:o.data,tblId:tblId,updateMethod:"pcle_updv"}
		...
		if(o.response){
			...
			if(o.msg.indexOf('Error..') > -1 ){
				...
				myAlert({container:'modal',type:'danger',tit:'Error!',msg:'los cambios no se registraron.',extra:''})
				TOP.send = false;
			}
		}
		break;
		...
		case 'print_reserva':
		console.log('printing boleto',TOP.data.datos_reserva);
		$('#printable_content').html(reserva.create(TOP.data.datos_reserva));
		$('#printable_content').printThis({
			importStyle:true,
			importCSS: true,
		});
		...
		if(o.sending){
			...
			if(o.action == 'response'){
				...
				$("#main_container").html(jb_views.create({title:"Editar Financiacion",id:'cfg_jb_cont'}));
