...
const reserva = {
  create : function(o){
    ...
    r += "</div>"; //cierra row 1
    // CARD 1
    r += "<div class='card mt-2 p-2'><div class='card-header'>DATOS DEL LOTE</div>"
    r += "<div class='card-body'>"
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>LOTE Nro.: "+o.lote+"</div><div class='col-4'>LISTA VIGENTE:     </div><div class='col-4'>ANTICIPO ($): "+o.anticipo+"</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-3'>VALOR DE CUOTAS ($): "+o.valor_ctas+"</div><div class='col-3'>CANTIDAD DE CUOTAS: "+o.cant_ctas_ciclo1+"</div><div class='col-3'>INDICE DE ACT.: "+o.indac+"</div><div class='col-3'>SALDO EN: "+o.cant_ctas_ciclo2+" </div></div>";
    // r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>VALOR TOTAL RESERVA ($): "+o.tot_reserva+" </div><div class='col-4'>DEJA ($): "+o.monto_parcial+" </div><div class='col-4'>SALDO ($): "+o.saldo_parcial+"</div></div>";
    // r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>VALOR RESERVA EN CUOTAS ($): "+o.valor_reserva_en_cuotas+"</div><div class='col-4'>CANT. DE CUOTAS: "+o.reserva_cant_ctas+" </div><div class='col-4'>VALOR DE CUOTA ($): "+o.reserva_valor_cta+" </div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>VALOR TOTAL RESERVA ($): "+o.tot_reserva+" </div><div class='col-4'>CANT. DE CUOTAS: "+o.reserva_cant_ctas+" </div><div class='col-4'>VALOR DE CUOTA ($): "+o.reserva_valor_cta+" </div></div>"
    r += "</div></div>";//cierra card
    // CARD 2
    r += "<div class='card mt-2 p-2'><div class='card-header'>COMPRADOR 1</div>"
    r += "<div class='card-body'>"
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-9'>NOMBRE/S Y APELLIDO/S : "+o.tit_nomap+"</div><div class='col-3'>DNI: "+o.tit_dni+" </div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>NRO. DE CUIL: "+o.tit_cuil+" </div><div class='col-8'>OCUPACION: "+o.tit_ocupacion+" </div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-12'>DIRECCIÓN: "+o.tit_domic+', '+o.tit_localidad+"</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>TEL.1: "+o.tit_tel+"</div><div class='col-4'>TEL.2 : "+o.tit_cel+"</div><div class='col-4'>MAIL: "+o.tit_email+" </div></div>";
    r += "</div></div>";//cierra card

    // CARD 3
    r += "<div class='card mt-2 p-2'><div class='card-header'>DATOS ADICIONALES (COMPRADOR 1)</div>"
    r += "<div class='card-body'>"
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-12'>NOMBRE/S Y APELLIDO/S : "+o.tit_nom_contacto+"</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-12'>DIRECCIÓN: "+o.tit_dom_contacto+"</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>PARENTESCO : "+o.tit_parentesco_contacto+" </div><div class='col-4'>TEL. : "+o.tit_tel_contacto+" </div><div class='col-4'>MAIL: "+o.tit_email_contacto+" </div></div>";
    r += "</div></div>";//cierra card

    // CARD 4
    r += "<div class='card mt-2 p-1'><div class='card-header'>COMPRADOR 2</div>"
    r += "<div class='card-body'>"
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-9'>NOMBRE/S Y APELLIDO/S : "+o.cotit_nomap+"</div><div class='col-3'>DNI: "+o.cotit_dni+" </div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>NRO. DE CUIL: "+o.cotit_cuil+"</div><div class='col-8'>OCUPACION: "+o.cotit_ocupacion+"</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-12'>DIRECCIÓN: "+o.cotit_domic+", "+o.cotit_locali+"</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>TEL.1: "+o.cotit_tel+"</div><div class='col-4'>TEL.2 : "+o.cotit_cel+"</div><div class='col-4'>MAIL: "+o.cotit_email+" </div></div>";
    r += "</div></div>";//cierra card

    // CARD 5
    r += "<div class='card mt-2 p-2'><div class='card-header'>DATOS ADICIONALES (COMPRADOR 2)</div>"
    r += "<div class='card-body'>"
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-12'>NOMBRE/S Y APELLIDO/S : "+o.cotit_nom_contacto+"</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-12'>DIRECCIÓN: "+o.cotit_dom_contacto+"</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4'>PARENTESCO : "+o.cotit_parentesco_contacto+"</div><div class='col-4'>TEL. : "+o.cotit_tel_contacto+" </div><div class='col-4'>MAIL: "+o.cotit_email_contacto+"</div></div>";
    r += "</div></div>";//cierra card

    r += "<div class='row d-flex justify-content-start mt-2 p-1'><div class='col-12'>OBSERVACIONES:__________________________________________________________________________________</div></div>";
    r += "<div class='d-flex justify-content-start p-2'>- Hasta la posesión deberá abonar el costo de mantenimiento del lote y los impuestos, si el lote ya tuviera las partidas otorgadas. La posesión del lote se entrega con "+o.cant_ctas_ciclo1+" cuotas pagas, se pueden adelantar cuotas.<br/>- El indice de actualización semestral de las cuotas del anticipo y del saldo expresado en esta ficha se revee cada 24 meses, pudiendo variar según lo estipulado en el contrato de compraventa en la clausula 2.3.<br/>- El saldo a pagar una vez completado el pago del anticipo, se podrá financiar hasta en  "+o.cant_ctas_ciclo2+" cuotas. Las cuotas adelantadas se toman al valor de la cuota del mes que se paga.<br/>- Una vez entregada la reserva por el interesado, no podrá solicitarse su devolución ni reclamo bajo ninguna circunstancia.<br/>- El comercializador notificará al interesado la fecha de firma del boleto de compraventa respectivo.<br/>- En caso de que el comprador no se presente a firmar el boleto de compraventa, se le considerará desistido de su oferta y ello originará automáticamente la perdida de la suma entregada en este acto en concepto de cláusula penal a favor de la comercializadora, debiéndose considerar como única indemnización por daños y perjuicios, quedando en ese momento rescindida la presente operación.<br/>- Validez de la reserva: 10 días.</div>";

    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-12'>FECHA Y HORARIO DE LA FIRMA : "+o.fecha_horario_firma+"</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-12'>DIRECCIÓN DE LA FIRMA : "+o.direccion_firma+"</div></div>";
    r += "<br/><br/><br/>";

    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4 d-flex justify-content-center'>_______________________________</div><div class='col-4 d-flex justify-content-center'>_______________________________</div><div class='col-4 d-flex justify-content-center'>_______________________________</div></div>";
    r +=  "<div class='row d-flex justify-content-start p-1'><div class='col-4 d-flex justify-content-center'>Firma comercializador</div><div class='col-4 d-flex justify-content-center'>Firma comprador 1</div><div class='col-4 d-flex justify-content-center'>Firma comprador 2</div></div>";
...
const boleto = {
  ...
  let c = '';
  c += "<div style='padding: 2cm;font-size: x-large;'><span align='CENTER' style='display:block;font-size:33px;font-weight:700;'>BOLETO DE COMPRAVENTA</span>";
  c += this.parrafo_1(o);
  c += "<span align='start' style='display:block;font-size:33px;font-weight:700;'>CONSIDERANDO QUE:</span>";
  c += this.parrafo_2(o);
  c += this.parrafo_3(o);
...
const dropdown = {
  create:function(v){
    ...
    c += "<button id=\'" +v.atom_id+"_"+v.label+ "\' ";
    ...
    if(TOP.permisos < 2){
      curr_select = TOP.selects[v.label];
     for (let i = 0; i < curr_select.length ; i++){
       c +="<a class=\"dropdown-item\" onClick=dropDownUpdate('"+v.atom_id+"_"+v.label+"','"+encodeURIComponent(curr_select[i].label) +"',"+JSON.stringify({'method':v.updateMethod,'label':v.label,'parent_id':v.atom_id,'sending':true})+") >"+curr_select[i].label+"</a>";
     }
    }
    c +="</div></div></div>";
    return c;
...
var td_updater = {
	...
	set: function(o){
		...
		// PONE EVENTS SOBRE EL TD PARA QUE REACIONE AL CAMBIO
			...
			if(o.vis_elem_type === 'text'){
				x += "<td contenteditable=\'true\' id='"+o.atom_id+"_"+o.label+"'";
				let val = {'method':o.updateMethod,'label':o.label,'parent_id':o.atom_id,'sending':true}
				x += "onFocus='set_curr_edited(this)' onBlur='front_call("+JSON.stringify(val)+")' oninput='validate_td_update(this.id)'>";
				x += o.value;
			}

			if(o.vis_elem_type === 'number'){
				x += "<td contenteditable=\'true\' id='"+o.atom_id+"_"+o.label+"'";
				let val = {'method':o.updateMethod,'label':o.label,'parent_id':o.atom_id,'sending':true}
				x += "onFocus='set_curr_edited(this)' onBlur='front_call("+JSON.stringify(val)+")' oninput='validate_td_update(this.id)'>";
				x += o.value;
			...
			else if (o.vis_elem_type === 'select') {
				x += "<td data-order=\'"+o.value+"\' data-search=\'"+o.value+"\'";
				x += dropdown.create(o);
			}
		}
		x += "</td>";
...
const otbl_editable={
	...
	create:function(v){
      ...
      for (let i of v.struct) {
        if(i.vis_ord_num > 0){
          r +=  "<th class=\'text-center\'>"+i.title+"</th>";
        }
      }
			r +="</thead></tr>";
      r +="<tbody>";
      ...
      if(v.data && Array.isArray(v.data)){
        for (let row in v.data){
          ...
          for (let col of v.struct){
            if(parseInt(col.vis_ord_num) > 0){
              let curr_value = {
                // pcle_id:v.data[row]['pcle_id'],
                atom_id:v.data[row]['atom_id'],
                value:v.data[row][col.label],
                label:col.label,
                vis_elem_type:col.vis_elem_type,
                updateMethod:v.updateMethod,
              }
              r += td_updater.create(curr_value)
            }
          }
          r += "</tr>";
        }
...
const data_box_small = {
	...
	set: function(v){
		...
		if(v.hasOwnProperty('edit_btn')){
			...
			edit = "<button type=\"button\" class=\"btn-normal\" onclick=\"front_call({method:'edit_dialog',sending:false,pcle_lbl:'"+v.pcle_lbl+"',elm_id:'"+TOP.curr_elem_id+"',container_id:'dbx_cl_body_"+v.id+"\'})\"><i class=\"material-icons \">create</i></button></li>";
		}
...
var clpsd_cards = {
  ...
  //**************** 6 de agosto 2020
    ...
    let r = "<div class=\'col d-flex justify-content-center pt-2\'>";
		r += dropdown.create({
      atom_id:this._data.lote.estado_contrato.atom_id,
      value:this._data.lote.estado_contrato.value,
      label:this._data.lote.estado_contrato.label,
      style:'btn-primary',
      updateMethod:'set_curr_state'});
		r += "</div>";
		return r
	},
...
var rec_pgc = {
	...
	set: function (){
		...
		this._print +="<div class=\"col\"><p>Domicilio: "+TOP.data.lote.datos_boleto.tit_domic+", "+TOP.data.lote.datos_boleto.tit_localidad+"</p>"
		this._print +="</div></div>";
		...
		if(TOP.hasOwnProperty('selects')){
			if(TOP.selects[v.label] != undefined){
				for (var i = 0; i < TOP.selects[v.label].length; i++) {
					var sl = (encodeURIComponent(TOP.selects[v.label][i].id) == encodeURIComponent(v.value))?"selected=\"selected\"":" ";
					x += "<option value="+encodeURIComponent(TOP.selects[v.label][i].id)+" "+sl+" > "+(TOP.selects[v.label][i].hasOwnProperty('label')?TOP.selects[v.label][i].label:TOP.selects[v.label][i].lbl)+"</option>";
				}
			}
		}
		x +="</select></div></div>";
