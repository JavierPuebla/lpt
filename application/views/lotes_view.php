...
<main class="container-fluid" id='main_container'role="main" style="padding-top: 65px;">
...
<script type="text/javascript">
				...
				<div class=\"col-lg-6 \">\
					...
					<div class=\"jumbotron\">\
						<p class=\"lead\" id=\"botpanel\">\
							<button type=\"button\" class=\"btn btn-secondary btn-lg btn-block\" onclick=\"front_call({'method':'list_lotes',sending:true})\">Listado de Lotes</button>\
							<button type=\"button\" class=\"btn btn-secondary btn-lg btn-block\" onclick=\"front_call({'method':'new_contrato_elem',sending:true,action:'call'})\">----</button>\
							<button type=\"button\" class=\"btn btn-secondary btn-lg btn-block\" onclick=\"front_call({'method':'atom_crude'})\">---</button>\
							</p>\
					</div>\
				</div>\
				<div class=\"col\"></div>\
	...
	$( window ).load(function() {
		...
		if (TOP.locked){
			...
			TOP.uploading = false;
			// if(TOP.permisos == 0 ){
			// 	$('#botpanel').append("<button type=\"button\" class=\"btn btn-secondary btn-lg btn-block\" onclick=\"front_call({'method':'list_audit'})\">listar elements</button>");
			// }
		}
	});
