...
class Vendedores extends CI_Controller {
	...
	function get_screen($u){
		$btns = [
			...
			['call'=>['method'=>'list','sending'=>true],'tag'=>'Listado de Vendedores'],
			['call'=>['method'=>'call_new_atom','sending'=>true,'action'=>'call','data'=>0],'tag'=>'Alta de Vendedor'],
	...
	function save_new_atom(){
		...
		if($atom_id){
			...
			$res =[
				'tit'=>'ALTA DE VENDEDORES',
				'msg'=>'Error No se registro el nuevo Vendedor',
				'type'=>'warning',
				'container'=>'modal',
				'win_close_method' => 'back'
			];
