...
class Productos extends CI_Controller {
	...
	function get_screen($u){
		$btns = [
			...
			['call'=>['method'=>'list','sending'=>true],'tag'=>'Listado de Productos'],
			['call'=>['method'=>'call_new_atom','sending'=>true,'action'=>'call','data'=>0],'tag'=>'Alta de Producto'],
