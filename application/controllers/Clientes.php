...
class Clientes extends CI_Controller {
    ...
    function get_lote($elm_id){
        ...
        if($cotit != ''){
            ...
            $cotit_cuil = $cotit->get_pcle('cuit_cuil')->value;
            $cotit_ocupacion = $cotit->get_pcle('ocupacion')->value;
            $cotit_cel = $cotit->get_pcle('celular')->value;
            $cotit_tel = $cotit->get_pcle('telefono')->value;
            ...
            $cotit_nom_contacto = $cotit->get_pcle('nombre_contacto')->value;
            $cotit_dom_contacto = $cotit->get_pcle('domicilio_contacto')->value.', '.$cotit->get_pcle('localidad_contacto')->value;
            $cotit_parentesco_contacto = $cotit->get_pcle('parentesco_contacto')->value;
            $cotit_tel_contacto = $cotit->get_pcle('tel_contacto')->value;
            $cotit_email_contacto = $cotit->get_pcle('email_contacto')->value;
        }else{
            $cotit_name = '';
            $cotit_dni = '';
            $cotit_cuil = '';
            ...
            $cotit_nom_contacto = '';
            $cotit_dom_contacto = '';
            $cotit_parentesco_contacto = '';
            $cotit_tel_contacto = '';
            $cotit_email_contacto = '';
        }
        ...
        $el = [
            ...
            'datos_boleto'=>[
                ...
                'tit_cuil'=> $cl->get_pcle('cuit_cuil')->value,
                'tit_ocupacion'=> $cl->get_pcle('ocupacion')->value,
                'tit_tel'=> $cl->get_pcle('telefono')->value,
                'tit_cel'=> $cl->get_pcle('celular')->value,
                'tit_domic'=>$cl->get_pcle('domicilio')->value,
                'tit_localidad'=>$cl->get_pcle('localidad')->value,
                'tit_email'=>$cl->get_pcle('email')->value,
                'tit_nom_contacto' => $cl->get_pcle('nombre_contacto')->value,
                'tit_dom_contacto' => $cl->get_pcle('domicilio_contacto')->value.', '.$cl->get_pcle('localidad_contacto')->value,
                'tit_parentesco_contacto' => $cl->get_pcle('parentesco_contacto')->value,
                'tit_tel_contacto' => $cl->get_pcle('tel_contacto')->value,
                'tit_email_contacto' => $cl->get_pcle('email_contacto')->value,
                'cotit_nomap'=>$cotit_name,
                'cotit_dni'=>$cotit_dni,
                'cotit_cuil'=>$cotit_cuil,
                'cotit_domic'=>$cotit_domic,
                'cotit_locali'=>$cotit_locali,
                'cotit_email'=>$cotit_email,
                'cotit_tel'=>$cotit_tel,
                'cotit_cel'=>$cotit_cel,
                'cotit_nom_contacto' =>$cotit_nom_contacto,
                'cotit_dom_contacto' => $cotit_dom_contacto,
                'cotit_parentesco_contacto' => $cotit_parentesco_contacto,
                'cotit_tel_contacto' => $cotit_tel_contacto,
                'cotit_email_contacto' => $cotit_email_contacto,
                'cod_lote'=>$l->name,
    ...
    function detalle_servicios_cancelados(){
      ...
      $q = "SELECT (SELECT value from events_pcles evp6 WHERE evp6.events_id = e.id AND evp6.label = 'fec_pago' limit 1) as 'Fecha de Pago',
      (SELECT value from events_pcles evp4 WHERE evp4.events_id = e.id AND evp4.label = 'nro_cta' limit 1) as 'Nro. de Cuota',
