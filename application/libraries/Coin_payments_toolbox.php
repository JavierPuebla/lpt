 ...
 *
 */
class Coin_payments_toolbox {

    /**************** CLASS PROPERTIES **************/
    // Container for Cobro Inmediato user's account informations
    public $account;
    public $debug;
    ...
    /**
     * Constructor, stores the Cobro Inmediato user's account informations
     * @param $args array(
     *    $shopID => string, the account site id as provided by Cobro Inmediato
     *    $certTest => string, certificate, test-version
     *    $certProd => string, certificate, production-version
     *    $ctxMode => string ("TEST" or "PRODUCTION"), the Cobro Inmediato mode to operate
     *    $platform => string URL
     * )
     */
    ...
    /**
     * getFormFields
     * Utility function, returns all the mandatory data needed by a Cobro Inmediato form payment
     * as an array
     *
     ...
     * during IPN request from Cobro Inmediato plat-form
     *
     * @param $fields array, the data received from Cobro Inmediato, usually the _POST PHP super-global
     *
     * @return array|bool
     */
     ...
     *  for Cobro Inmediato signature
     *
     * @param $fields array data received from Cobro Inmediato
     * (typically $_POST)
     *
    ...
    public function getIpn(){
        ...
        if( isset($_POST['vads_trans_status'])){
            ...
            try {
                ...
                $error_msg= '### ERROR - An exception raised during IPN Cobro Inmediato process:';
